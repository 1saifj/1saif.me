...
import { publishedBlogs } from '../src/data/blogs.js'
import { projects } from '../src/data/projects.js'

// Load environment variables
const ALGOLIA_APP_ID = process.env.VITE_ALGOLIA_APP_ID || 'demo'
const ALGOLIA_ADMIN_KEY = process.env.VITE_ALGOLIA_ADMIN_KEY || 'demo'
const ALGOLIA_INDEX_NAME = process.env.VITE_ALGOLIA_INDEX_NAME || 'demo_index'

...
import { ArrowLeft, Calendar, Clock, Eye, ShareNetwork, BookOpen, Tag, User, Coffee, Medal, Lightning, TrendUp } from '@phosphor-icons/react';
...
export const BlogPost: React.FC = () => {
 ...
 >
 <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" weight="duotone" />
 ...
 <span 
 key={tag}
 className="inline-flex items-center px-3 py-1 bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm text-slate-600 dark:text-slate-300 rounded-full text-sm font-medium border border-slate-200/50 dark:border-zinc-600/50"
 itemProp="keywords"
 >
 <Tag className="w-3 h-3 mr-1.5" weight="duotone" />
 {tag}
 </span>
 ))}
 ...
 <Clock className="w-3 h-3 mr-1.5" weight="duotone" />
 5 min read
 </span>
 </div>
 ...
 <div className="flex items-center gap-4 pt-6 border-t border-slate-200/50 dark:border-zinc-700/50">
 <img 
 ...
 {/* Article Content */}
 <section className="py-8 sm:py-12 lg:py-16 bg-white dark:bg-[#0a0a0a]">
 ...
 [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:text-slate-900 [&>h2]:dark:text-white [&>h2]:mb-4 [&>h2]:mt-8 [&>h2]:leading-tight [&>h2]:border-b [&>h2]:border-slate-200 [&>h2]:dark:border-zinc-700 [&>h2]:pb-2
 ...
 [&_.copy-button]:px-3 [&_.copy-button]:py-1.5 [&_.copy-button]:text-xs [&_.copy-button]:font-medium [&_.copy-button]:bg-white [&_.copy-button]:dark:bg-slate-600 [&_.copy-button]:text-slate-600 [&_.copy-button]:dark:text-slate-300 [&_.copy-button]:border [&_.copy-button]:border-slate-300 [&_.copy-button]:dark:border-zinc-500 [&_.copy-button]:rounded-md [&_.copy-button]:hover:bg-slate-50 [&_.copy-button]:dark:hover:bg-slate-500 [&_.copy-button]:hover:text-slate-800 [&_.copy-button]:dark:hover:text-slate-100 [&_.copy-button]:transition-all [&_.copy-button]:duration-200 [&_.copy-button]:opacity-80 [&_.copy-button]:hover:opacity-100
 ...
 [&>table]:w-full [&>table]:mb-6 [&>table]:border-collapse [&>table]:border [&>table]:border-slate-300 [&>table]:dark:border-zinc-600
 [&>table_th]:bg-slate-100 [&>table_th]:dark:bg-slate-800 [&>table_th]:p-3 [&>table_th]:text-left [&>table_th]:font-semibold [&>table_th]:border [&>table_th]:border-slate-300 [&>table_th]:dark:border-zinc-600
 [&>table_td]:p-3 [&>table_td]:border [&>table_td]:border-slate-300 [&>table_td]:dark:border-zinc-600
 ...
 [&>hr]:my-8 [&>hr]:border-slate-300 [&>hr]:dark:border-zinc-600
 
 [&>img]:max-w-full [&>img]:h-auto [&>img]:rounded-lg [&>img]:my-6 [&>img]: [&>img]:mx-auto
 ...
 {/* Article Footer */}
 <div className="mt-16 pt-8 border-t border-slate-200 dark:border-zinc-700">

...
import { ArrowRight, Clock, Tag, TrendUp, Brain } from '@phosphor-icons/react';
...
export const ContentRecommendations: React.FC<ContentRecommendationsProps> = ({ 
 ...
 <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-zinc-700">
 <div className="flex items-center space-x-2 mb-6">
 <Brain className="w-5 h-5 text-blue-600 dark:text-blue-400 animate-pulse-subtle" weight="duotone" />
 ...
 return (
 <div className={`${className}`}>
 <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 border border-blue-200 dark:border-zinc-700">
 <div className="flex items-center space-x-2 mb-6">
 ...
 <TrendUp className="w-4 h-4 text-blue-600 dark:text-blue-400" weight="duotone" />
 ...
 className="group block p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-zinc-700 hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-150 hover:shadow-md hover:-translate-y-0.5"
 >
 ...
 <div className="flex items-center space-x-1">
 <Tag className="w-3 h-3" weight="duotone" />
 <span>{rec.tags.slice(0, 2).join(', ')}</span>
 </div>
 </div>

 <ArrowRight className="w-4 h-4 text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:translate-x-0.5 transition-all duration-150" weight="duotone" />
 </div>
 ...
 <div className="mt-6 p-4 bg-blue-50 dark:bg-slate-700/50 rounded-xl border border-blue-200 dark:border-zinc-600">

...
import { Copy, Check, Eye, Code, Palette, Sparkle } from '@phosphor-icons/react';
...
export const MyNewsletterComponent = () => {
 ...
 <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-medium mb-6 ">
 ...
 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 dark:border-zinc-700/50 sticky top-6">
 <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
 <Palette className="w-5 h-5 mr-2 text-blue-600" weight="duotone" />
 Choose Template
 </h3>
 ...
 {/* View Mode Toggle */}
 <div className="mt-6 pt-6 border-t border-slate-200 dark:border-zinc-600">
 ...
 <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-zinc-700/50 overflow-hidden">
 {viewMode === 'preview' ? (
 <div className="p-8">
 ...
 <div className="bg-slate-100 dark:bg-[#0a0a0a] rounded-xl p-6">
 ...
 {copiedCode ? (
 <>
 <Check className="w-4 h-4 text-green-400" weight="duotone" />
 <span>Copied!</span>
 </>
 ) : (
 <>
 ...
 <Code className="w-5 h-5 mr-2 text-blue-600" weight="duotone" />
 How to Use
 </h4>

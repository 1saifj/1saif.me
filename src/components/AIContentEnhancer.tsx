...
import { Tag, Key, Target, ArrowsClockwise, Check, WarningCircle, Brain } from '@phosphor-icons/react';
...
export const AIContentEnhancer: React.FC<AIContentEnhancerProps> = ({
 ...
 <ArrowsClockwise className="w-5 h-5 text-blue-600 dark:text-blue-400 animate-spin" style={{animationDuration: '2s'}} weight="duotone" />
 ...
 <WarningCircle className="w-5 h-5 text-red-600 dark:text-red-400" weight="duotone" />
 ...
 <Brain className="w-6 h-6 text-emerald-600 dark:text-emerald-400" weight="duotone" />
 </div>
 <div>
 ...
 <Check className="w-6 h-6 text-emerald-600 dark:text-emerald-400" weight="duotone" />
 </div>
 </div>
 ...
 <Target className="w-5 h-5 text-blue-600 dark:text-blue-400" weight="duotone" />
 <h4 className="font-semibold text-slate-900 dark:text-white">AI Summary</h4>
 </div>
 <p className="text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-zinc-700">
 {enhancement.summary}
 </p>
 </div>
 )}
 ...
 <div className="mb-6">
 <div className="flex items-center space-x-2 mb-3">
 <Tag className="w-5 h-5 text-purple-600 dark:text-purple-400" weight="duotone" />
 ...
 : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-zinc-700'
 } border`}
 >
 {isNew && <Check className="w-3 h-3 mr-1" weight="duotone" />}
 {tag}
 </span>
 )
 })}
 ...
 <div className="mb-6">
 <div className="flex items-center space-x-2 mb-3">
 <Key className="w-5 h-5 text-amber-600 dark:text-amber-400" weight="duotone" />
 ...
 <li
 key={index}
 className="flex items-start space-x-3 text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 rounded-lg p-3 border border-slate-200 dark:border-zinc-700"
 >
 ...
 <div>
 <div className="flex items-center space-x-2 mb-3">
 <Target className="w-5 h-5 text-indigo-600 dark:text-indigo-400" weight="duotone" />
 <h4 className="font-semibold text-slate-900 dark:text-white">SEO Optimization</h4>
 </div>
 <div className="space-y-3">
 {enhancement.seoTitle !== title && (
 <div className="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-zinc-700">

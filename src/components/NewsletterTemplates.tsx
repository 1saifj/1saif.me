...
import { Envelope, Lightning, TrendUp, BookOpen, Users, CheckCircle, ArrowRight, Heart, Shield, Medal, FileText } from '@phosphor-icons/react';
...
export const GradientHeroNewsletter: React.FC<NewsletterTemplateProps> = ({ onSubscribe, isLoading }) => {
 ...
 <CheckCircle className="w-8 h-8 animate-pulse" weight="duotone" />
 </div>
 </div>
 )
 }
 ...
 type="submit"
 disabled={isLoading}
 className="px-6 py-3 bg-white text-purple-600 font-semibold rounded-xl hover:bg-white/90 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover: transform hover:scale-105"
 >
 {isLoading ? (
 ...
 <Shield className="w-4 h-4 inline mr-1" weight="duotone" />
...
export const MinimalistCardNewsletter: React.FC<NewsletterTemplateProps> = ({ onSubscribe, isLoading }) => {
 ...
 if (isSubmitted) {
 return (
 <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-zinc-700 text-center">
 <div className="w-16 h-16 mx-auto mb-6 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
 <CheckCircle className="w-8 h-8 text-green-600 dark:text-green-400" weight="duotone" />
 </div>
 ...
 return (
 <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-zinc-700 transition-all duration-300 hover:">
 <div className="text-center mb-8">
 <div className="w-12 h-12 mx-auto mb-4 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
 <Envelope className="w-6 h-6 text-blue-600 dark:text-blue-400" weight="duotone" />
 </div>
 ...
 className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-zinc-600 rounded-lg text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
 required
 />
 </div>
...
export const FeatureRichNewsletter: React.FC<NewsletterTemplateProps> = ({ onSubscribe, isLoading }) => {
 ...
 { icon: TrendUp, title: 'Industry Insights', desc: 'Latest trends and emerging technologies' },
 { icon: Lightning, title: 'Quick Tips', desc: 'Actionable advice you can use immediately' },
 ...
 <CheckCircle className="w-10 h-10 text-green-600 dark:text-green-400" weight="duotone" />
 </div>
 ...
 return (
 <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 border border-slate-200 dark:border-zinc-700">
 <div className="text-center mb-8">
 ...
 className="flex-1 px-4 py-3 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-zinc-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
 required
 />
 <button
 type="submit"
 disabled={isLoading}
 className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 hover: transform hover:scale-105"
 >
 {isLoading ? (
 <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" style={{animationDuration: '1s'}}></div>
 ) : (
...
export const CompactInlineNewsletter: React.FC<NewsletterTemplateProps> = ({ onSubscribe, isLoading }) => {
 ...
 return (
 <div className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-zinc-700 rounded-lg p-4">
 <div className="flex items-center space-x-3 mb-3">
 <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
 <Envelope className="w-4 h-4 text-blue-600 dark:text-blue-400" weight="duotone" />
 </div>
 <div>
 ...
 className="flex-1 px-3 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-zinc-600 rounded text-sm text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
 required
 />
 <button
 type="submit"
...
export const AnimatedInteractiveNewsletter: React.FC<NewsletterTemplateProps> = ({ onSubscribe, isLoading }) => {
 ...
 if (isSubmitted) {
 return (
 <div className="relative overflow-hidden bg-gradient-to-br from-emerald-400 via-cyan-400 to-blue-500 rounded-3xl p-8 text-white ">
 ...
 return (
 <div 
 className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-pink-600 to-red-500 rounded-3xl p-8 transition-all duration-500 hover:shadow-3xl hover:scale-105"
 ...
 type="submit"
 disabled={isLoading}
 className="w-full bg-white text-purple-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 hover: transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none group relative overflow-hidden"
 >
 ...
 <>
 <Lightning className="w-5 h-5 group-hover:animate-pulse" weight="duotone" />
 ...
 <Shield className="w-4 h-4" weight="duotone" />

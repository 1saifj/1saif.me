...
import { X, Shield, Cookie, Eye } from '@phosphor-icons/react';
...
const GDPRBanner: React.FC<GDPRBannerProps> = ({ onAccept, onDecline }) => {
 ...
 <div className="bg-white dark:bg-gray-900 border-t md:border md:rounded-lg ">
 {/* Header */}
 <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
 <div className="flex items-center space-x-2">
 <Shield className="w-5 h-5 text-blue-600" weight="duotone" />

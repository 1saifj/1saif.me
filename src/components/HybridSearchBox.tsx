...
import { MagnifyingGlass, X, FileText, User, Briefcase, Command, ArrowRight, Clock, Tag, WifiHigh, WifiSlash } from '@phosphor-icons/react';
...
export const HybridSearchBox: React.FC<SearchBoxProps> = ({ isOpen, onClose }) => {
 ...
 switch (type) {
 case 'blog': return <FileText className="w-4 h-4" weight="duotone" />
 case 'project': return <Briefcase className="w-4 h-4" weight="duotone" />
 case 'page': return <User className="w-4 h-4" weight="duotone" />
 case 'skill': return <Tag className="w-4 h-4" weight="duotone" />
 default: return <MagnifyingGlass className="w-4 h-4" weight="duotone" />
 }
 }
 ...
 <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-zinc-700 w-full max-w-2xl overflow-hidden">
 {/* MagnifyingGlass Input */}
 <div className="flex items-center p-4 border-b border-slate-200 dark:border-zinc-700">
 <MagnifyingGlass className="w-5 h-5 text-slate-400 mr-3" weight="duotone" />
 <input
 ref={inputRef}
 type="text"
 value={query}
 ...
 placeholder="MagnifyingGlass projects, articles, skills..."
 ...
 {/* MagnifyingGlass mode indicator */}
 <div className="flex items-center space-x-1">
 {isOnline ? (
 <WifiHigh className={`w-3 h-3 ${searchMode === 'algolia' ? 'text-green-500' : 'text-yellow-500'}`} weight="duotone" />
 ) : (
 <WifiSlash className="w-3 h-3 text-red-500" weight="duotone" />
 )}
 ...
 <Command className="w-3 h-3" weight="duotone" />
 </div>
 <span>+</span>
 ...
 >
 <X className="w-5 h-5 text-slate-400" weight="duotone" />
 </button>
 </div>
 </div>
 ...
 <MagnifyingGlass className="w-12 h-12 text-slate-300 dark:text-slate-600 mx-auto mb-4" weight="duotone" />
 ...
 <ArrowRight className="w-4 h-4 text-slate-400" weight="duotone" />
 </button>
 ))}
 </div>
 )}

...
import { Clock, Calendar, ArrowRight, Tag, TrendUp, Eye } from '@phosphor-icons/react';
...
export const RelatedPosts: React.FC<RelatedPostsProps> = ({ 
 ...
 <TrendUp className="w-5 h-5 text-white" weight="duotone" />
 </div>
 ...
 >
 <article className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm hover: transition-all duration-300 border border-slate-200 dark:border-zinc-700 hover:border-blue-300 dark:hover:border-blue-600 hover:scale-[1.02]">
 ...
 <ArrowRight className="w-4 h-4 text-slate-600 dark:text-slate-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:translate-x-1 transition-all duration-200" weight="duotone" />
 </div>
 </div>
 </div>
 ...
 >
 <Tag className="w-2.5 h-2.5" weight="duotone" />
 <span>{tag}</span>
 </span>
 )
 })}

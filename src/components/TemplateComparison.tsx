...
import { Sparkle, Layout, Palette, Code } from '@phosphor-icons/react';
...
export const TemplateComparison: React.FC = () => {
 ...
 return (
 <div key={template.key} className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 dark:border-zinc-700/50">
 <div className="mb-6">
 ...
 <Layout className="w-5 h-5 text-blue-600" weight="duotone" />
 <Palette className="w-5 h-5 text-purple-600" weight="duotone" />
 <Code className="w-5 h-5 text-green-600" weight="duotone" />
 </div>
 </div>
 ...
 {/* Template Preview */}
 <div className="bg-slate-100 dark:bg-[#0a0a0a] rounded-2xl p-4">
 ...
 <Sparkle className="w-4 h-4 text-white" weight="duotone" />
 </div>
 <div>
